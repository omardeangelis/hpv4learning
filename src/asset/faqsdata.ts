export const faqs = [
  ...
  },
  {
    ...
    description:
      "Avere esperienza lavorativa con la materia di insegnamento è necessario. La nostra politica è di proporre solo corsi di qualità da parte di professionisti del settore.",
  },
  {
